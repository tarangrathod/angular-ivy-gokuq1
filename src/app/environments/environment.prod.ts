export const environment = {
  production: true,
  siteKey: '6LdCGAoaAAAAAEeAuuDDwJL129QScM13a0cmeJ91',
  showAppList: [],
  // 6LfOMwoaAAAAAAaNM08WwXsxdsFP8-vkQ1nH0dqC
  ...
  apiUrl: 'https://api.zignexlogistics.com/zextd/',
  authenticationEnabled: true,
  isTomtom: true,
  geoServerUrl: 'https://geoserver.zignexlogistics.com/geoserver/zignex/wms',
  mapTileGeoserverUrl: 'http://geoserver.zignexlogistics.com/geoserver/wms',
